...
function ShoppingCheckout() {
  ...
  const handleInitiateStripePayment = () => {
    ...
    dispatch(createNewOrder(orderData)).then((data) => {
      if (data?.payload?.success) {
        window.location.href = data.payload.url; // Redirect to Stripe Checkout URL
  ...
  <img 
    src="https://res.cloudinary.com/dxhykrh2a/image/upload/v1726250267/zrem2qwgodkdemj3bgvc.webp"
